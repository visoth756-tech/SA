...
function TableProduct({ title, productLists, loading, setLoading, handleOpenEdit, loadProduct }) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.log("Delete Failed:", err.response?.data?.message);
    } finally {
      setLoading(false);
    }
  };
            ...
            `}
              ...
              <div className="flex flex-col justify-between p-4">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-2">{item?.Category?.category_name || "Uncategordized"}</p>
                </div>
                <div>
